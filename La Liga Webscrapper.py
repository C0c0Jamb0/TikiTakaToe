...
for season in seasons:
    ...
    page = f"https://www.transfermarkt.de/laliga/startseite/wettbewerb/ES1/plus/?saison_id={season}"
...
df.to_csv('laliga_players_by_season.csv', index=False, encoding='utf-8-sig')
