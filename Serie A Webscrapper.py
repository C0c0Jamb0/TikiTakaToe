...
for season in seasons:
    ...
    page = f"https://www.transfermarkt.de/serie-a/startseite/wettbewerb/IT1/plus/?saison_id={season}"
...
df.to_csv('serieA_players_by_season.csv', index=False, encoding='utf-8-sig')
